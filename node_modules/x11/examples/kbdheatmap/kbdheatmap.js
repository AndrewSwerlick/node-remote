...
x11.createClient(function(display) {
    ...
    var gc = X.AllocID();
    X.CreateGC(gc, win, { foreground: black, background: white } );
            ...
            //
            //X.PutImage(2, pixmapKbd, gc, kbdImg.width, kbdImg.height, 0, 0, 0, 32, kbdImg.data);

            var picWin = X.AllocID();
            Render.CreatePicture(picWin, win, Render.rgb24);
            
            //X.PutImage(2, win, gc, kbdImg.width, kbdImg.height, 0, 0, 0, 24, kbdImg.data);
            //Render.Composite(3, picWin, 0, picKbd, 0, 0, 0, 0, 0, 0, kbdImg.width, kbdImg.height);
